...
int progress_report(void* instance, double x, double fx, double min, double fmin, double a, double b, int k) {
...
int test_minus_exp_minus_x_times_sin_x() {
  ...
  param.epsilon = 1e-5;
  ASSERT_SUCCESSFUL(gss(0, 1.5, &min, &fmin, minus_exp_minus_x_times_sin_x, progress_report, 0, &param));
...
int main(int argc, char* argv[]) {
  ...
  RUN_TEST_CASE(test_minus_exp_minus_x_times_sin_x, "GSS on f(x) = -e^x * sin(x)");
