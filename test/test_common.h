...
#define RUN_TEST_CASE(func, label)             \
  do {                                         \
    int result;                                \
...
#define ASSERT_ALMOST_EQUAL(obs, exp, eps)                                                                                      \
  do {                                                                                                                          \
    double diff = (obs) - (exp);                                                                                                \
...
#define ASSERT_WITHIN_RANGE(obs, lo, hi)                                                                                        \
  do {                                                                                                                          \
    if (obs < lo || obs > hi) {                                                                                                 \
